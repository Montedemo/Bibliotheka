...
# `=this.file.name`
Descripción: <p>Hace que el agua resbale sobre un objeto o criatura, protegiendo al blanco y a sus atuendos de la humedad. El hechizo se rompe si el objetivo es sumergido en el agua.</p>
