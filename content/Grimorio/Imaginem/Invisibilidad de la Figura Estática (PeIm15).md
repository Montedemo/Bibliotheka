...
# `=this.file.name`
Descripción: <p>El objetivo se vuelve invisible, pero el hechizo se acabará si se mueve (aparte de respirar o moverse ligeramente en el sitio). El objetivo seguirá proyectando sombra.</p>
