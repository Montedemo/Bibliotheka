...
# `=this.file.name`
Descripción: <p>Hace que cualquier persona u objeto aparente estar a un metro de su posición real. La imagen no podrá situarse dentro de un objeto sólido. Tan pronto como se mueva la imagen o su original, el hechizo terminará.</p>
