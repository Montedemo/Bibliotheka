...
# `=this.file.name`
Descripción: <p>Rompe un objeto de piedra, o que sea de un material más débil que esta, de hasta un metro de diámetro. La Forma apropiada para el objetivo es un requisito de lanzamiento.</p>
